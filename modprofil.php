...
<div class="row col-md-8 m-auto">
    ...
    <div class="col-md-9 col-sm-12 tab-content" id="nav-tabContent">
        ...
        <ul class="nav nav-tabs" id="list-tab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark font-weight-bold active" href="modprofil.php" id="list-profile-list" data-toggle="list" role="tab" aria-controls="home">Modifier mon email</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-dark font-weight-bold active" href="modprofil.php" id="list-profile-list" data-toggle="list" role="tab" aria-controls="home">Modifier mon adresse</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-dark font-weight-bold active" href="modprofil.php" id="list-profile-list" data-toggle="list" role="tab" aria-controls="home">Modifier mon téléphone</a>
            </li>
        </ul>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane pt-5 fade show active" id="list-about" role="tabpanel" aria-labelledby="list-profile-list">
                <div class="col row">
                    <form class="row col mb-5" action="insertion.php" method="post">
                        <div class="fo rm-group col-md-12 col-sm-12 row">
                            <label for="login" class="col-md-3 col-sm-12">Nom d'utilisateur </label>
                            <input type="text" minlength="3" name="username" class="form-control  col-md-4 col-sm-12" id="username" placeholder="username" value="" required>
                        </div>
                        <div class="form-group col-md-12 col-sm-12 row">
                            <label for="email" class="col-md-3 col-sm-12">Adresse email </label>
                            <input type="email" name="email" class="form-control  col-md-4 col-sm-12" id="email" placeholder="Email" value="" required>
                        </div>
                        <div class="form-group col-md-12 col-sm-12 row">
                            <label for="password" class="col-md-3 col-sm-12">Mot de passe </label>
                            <input type="password" name="password" class="form-control col-md-4 col-sm-12" id="password" placeholder="Password" value="" required>
                        </div>
